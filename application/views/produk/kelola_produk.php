                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <button class="btn btn-warning btn-sm" id="btnedit" data-id="<?php echo $p->id_produk  ?>" title="Atur">
                                <i class="fa fa-edit"></i>
                            </button>
                            <button class="btn btn-danger btn-sm" id="btndel" data-id="<?php echo $p->id_produk  ?>" title="Hapus">
            ...
            <div class="modal-body">
                <form role="form" id="frmUbh">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="id_produk" name="id_produk" placeholder="Masukan ID" readonly>
                    </div>
                    <div class="form-group">
                        <label>Tanggal </label>
...
<script script type="text/javascript">
    $(document).ready(function() {
        $(document).on('click', '#btnedit', function() {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url();  ?>produk/cari",
                dataType: "json",
                data: {
                    id_produk: id_produk
                },
